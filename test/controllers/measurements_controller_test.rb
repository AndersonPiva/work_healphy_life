...
class MeasurementsControllerTest < ActionController::TestCase
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post :create, measurement: { date: @measurement.date, nameMeasure: @measurement.nameMeasure, patient_id: @measurement.patient_id, size: @measurement.size }
    end
  ...
  test "should update measurement" do
    patch :update, id: @measurement, measurement: { date: @measurement.date, nameMeasure: @measurement.nameMeasure, patient_id: @measurement.patient_id, size: @measurement.size }
    assert_redirected_to measurement_path(assigns(:measurement))
  end
