...
class WeighingsControllerTest < ActionController::TestCase
  ...
  test "should create weighing" do
    assert_difference('Weighing.count') do
      post :create, weighing: { dateWeighing: @weighing.dateWeighing, patient_id: @weighing.patient_id, weight: @weighing.weight }
    end
  ...
  test "should update weighing" do
    patch :update, id: @weighing, weighing: { dateWeighing: @weighing.dateWeighing, patient_id: @weighing.patient_id, weight: @weighing.weight }
    assert_redirected_to weighing_path(assigns(:weighing))
  end
