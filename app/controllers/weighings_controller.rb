class WeighingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @weighing.save
        format.html { redirect_to weighings_path, notice: I18n.t('register_created') }
      else
  ...
  def update
    ...
    respond_to do |format|
      if @weighing.update(weighing_params)
        format.html { redirect_to weighings_path, notice: I18n.t('register_updated') }
      else
  ...
  def destroy
    ...
    @recent_activity.save
    respond_to do |format|
      format.html { redirect_to weighings_url, notice: I18n.t('register_destroyed') }
